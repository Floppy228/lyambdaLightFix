...
## Ошибки
1. Требует кучу .dll – по первой ссылке запроса "Latest Microsoft Visual C++ Redistributable Version" скачаиваем установщик(vc_redist...) под свою разрядность системы и запускаем его.
